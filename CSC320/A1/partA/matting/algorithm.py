...
class Matting:
    ...
    # Copy triangulation matting algorithm output - object Colour & Alpha images
    # from the images holding the input to the compositing algorithm. 

    # => can do compositing right after triangulation matting 
    #                   without having to save the object Color and object Alpha images to disk
    
    # This routine is NOT used for partA of the assignment.
    ...
    #   - copy its contents to matting instance's private dictionary object 
    #   - dictionary: key   - image variable
    #                       - should be one of the strings in lines 54-63. S
    #   See run() in run.py for examples
    #
    # if succeeded: 
    #   return True
    # else: 
    #   leave matting instance's dictionary entry unaffected 
    ...
    # Use OpenCV to:
    #   - write to a file an image in the instance's private dictionary. 
    #       - key specifies which image should be written & one of the strings in lines 54-63. 
