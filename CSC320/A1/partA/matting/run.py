...
# Upon success, 
#   returns any unprocessed/unrecognized arguments 
#
# Input arguments
...
# Return values
#   - True if all the required arguments are specified, False otherwise
#   - Namespace() object - contains user-specified arguments and
#                           any optional arguments that take default values
#   - string - any unrecognized/unprocessed command-line arguments
